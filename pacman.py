...
while True:
    ...
    while status == 1:     
        ...
        janela.draw_text(("Pontos:"), 0, 0, size=18, font_name="Arial", bold=True, italic = True, color=[255, 255, 255])
        janela.draw_text (str(pontos), 45, 0, size=18, font_name="Arial", bold=True, italic = True, color=[255, 255, 255])  
        janela.update()
